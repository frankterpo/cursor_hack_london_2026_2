...
const {
  analyzeGitHubRepo,
  buildRepoId,
} = require("../guild-bounty-board/public/api/_lib/github-analysis");
const {
  generateAiSummary,
} = require("../guild-bounty-board/public/api/_lib/ai-analysis");
const {
  getSubmissions,
  upsertSubmission,
  upsertAnalysis,
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (submission.repo_key === TEMPLATE_REPO_KEY) {
      return sendJson(res, 400, {
        error: "Please replace the example/template repository URL with your real project repository.",
      });
    }
