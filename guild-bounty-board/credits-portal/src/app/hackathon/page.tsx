...
/** Only page that carries partner / event-specific marketing; credits shell stays neutral. */
    ...
    <div className="min-h-screen pb-20">
      ...
      <main className="hackathon-landing-main mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
        <header className="panel-event relative overflow-hidden p-8 sm:p-10">
          <p className="eyebrow-event">Hackathon</p>
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <Link href="/redeem" className="btn-event-primary px-6 py-3 text-sm">
              Redeem Cursor credits
            </Link>
            <Link href="/" className="btn-event-ghost px-6 py-3 text-sm">
              Credits home
            </Link>
          </div>
        </header>
